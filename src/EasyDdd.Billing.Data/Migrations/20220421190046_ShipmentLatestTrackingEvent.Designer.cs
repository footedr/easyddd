...
namespace EasyDdd.Billing.Data.Migrations
{
    ...
    [Migration("20220421190046_ShipmentLatestTrackingEvent")]
    partial class ShipmentLatestTrackingEvent
    {
            ...
            modelBuilder.Entity("EasyDdd.Billing.Core.Shipment", b =>
                {
                    ...
                    b.OwnsOne("EasyDdd.Billing.Core.TrackingEvent", "LatesTrackingEvent", b1 =>
                        {
                            b1.Property<int>("ShipmentId")
                                .HasColumnType("int");
                    ...
                    b.Navigation("LatesTrackingEvent");

...
public class HistoryModel : PageModel
{
	...
	public HistoryModel(IReadModel<Shipment> readModel, IMediator mediator)
	{
	...
	public async Task<IActionResult> OnGet()
	{
		...
		if (shipment == null)
		{
			return RedirectToPage("/errors/404", new { msg = $"Shipment #{ShipmentId} was not found." });
		}
	...
	public async Task<IActionResult> OnPost()
	{
		...
		{
			_ = await _mediator.Send(new AddTrackingEventCommand(User, ShipmentId, TrackingEventRequest));
		}
